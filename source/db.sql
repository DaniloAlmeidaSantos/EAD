...
CREATE TABLE PROFESSORES (
    ...
    FOTO_PERFIL VARCHAR(160) NOT NULL,
    create_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    update_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE MATERIAS(
    ...
    CONSTRAINT FK_IDPROFESSOR_MATERIAS FOREIGN KEY (ID_PROFESSOR) REFERENCES PROFESSORES (ID),
    CONSTRAINT FK_IDTURMA_MATERIAS FOREIGN KEY (ID_TURMA) REFERENCES TURMAS (ID)
) CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO DISCIPLINAS (NOME_DISCIPLINA) VALUES ("INGLES");
